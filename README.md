...
Optional verwendet „Mit 4×-Lupe auswählen“ eine über das interaktive Screenshot-Portal freigegebene Bildschirmaufnahme als Standbild. Wähle im KDE-Dialog **Vollbild**, dann **Übernehmen** (je nach Übersetzung „Aufnehmen“) und **Speichern**. Dafür bleiben ab der Screenshot-Anfrage bis zu 20 Sekunden Zeit. **Abbrechen** im KDE-Dialog beendet die Aufnahme; danach öffnet sich die Auswahl ohne Lupe und kann mit **Esc** beendet werden. Bei Fehlern oder nach 20 Sekunden ohne Bild öffnet sich die Auswahl ebenfalls ohne Lupe; die ausstehende Anfrage wird geschlossen. Falls ein älterer KDE-Freigabedialog offen bleibt, schließe ihn mit „Deny“/„Verweigern“. Dieser Ablauf umgeht die blockierende nichtinteraktive Erstfreigabe von xdg-desktop-portal 1.22.1. Details zum ursprünglichen Fix stehen im [Regressionstestbericht](tests/PORTAL_FIX_REPORT.md). Die Aufnahme ist keine Live-Vorschau.
